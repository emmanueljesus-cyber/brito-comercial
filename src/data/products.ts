...
/** URL base do site WordPress — todas as imagens de produto vêm daqui */
const WP = 'https://britocomercial.com.br'

/** Prefixar o caminho com a URL do WordPress */
const wp = (path: string): string => `${WP}${path}`
...
export const maisVendidos: Product[] = [
  {
    ...
    image: wp('/wp-content/uploads/2023/12/caixa-de-som-portatil-para-festas-com-bluetooth-e-efeitos-de-luzes-preto-103459-1612471927-2-1-1-300x300.jpg'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/transferir-9-1-300x300.webp'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898010801846_1-300x300.webp'),
    category: 'Hidráulico',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7908576600439_1-300x300.jpg'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/thumb_400-400-arame-recozido-2-vergalhao-aco-1-300x300-1.webp'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7899719802011_1-300x300.webp'),
    category: 'Pisos e Revestimentos',
    categorySlug: 'pisos-e-revestimentos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898187882945_1-300x300.webp'),
    category: 'Telhas',
    categorySlug: 'telhas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7896039799953_1-300x300.webp'),
    category: 'Banheiro',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7899060611843_1-300x300.webp'),
    category: 'Pisos e Revestimentos',
    categorySlug: 'pisos-e-revestimentos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-0005302928908_1-300x300.webp'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7891461065058_1-300x300.webp'),
    category: 'Banheiro',
    categorySlug: 'banheiro',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7891467068435_1-300x300.webp'),
    category: 'Banheiro',
    categorySlug: 'banheiro',
...
export const materiaisEletricos: Product[] = [
  {
    ...
    image: wp('/wp-content/uploads/2024/06/gtd-300x300.webp'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7897381600607_1-300x300.webp'),
    category: 'Materiais Elétricos',
    categorySlug: 'cabos-e-fios',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7897381600645_1-300x300.png'),
    category: 'Materiais Elétricos',
    categorySlug: 'cabos-e-fios',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/carjas-s3-ecommerce-carajasonline-7891435046403_1-300x300-1.webp'),
    category: 'Materiais Elétricos',
    categorySlug: 'cabos-e-fios',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/carjas-s3-ecommerce-carajasonline-7898330614386_1-300x300-1.webp'),
    category: 'Materiais Elétricos',
    categorySlug: 'cabos-e-fios',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/carjas-s3-ecommerce-carajasonline-7891435937916_1-300x300-1.webp'),
    category: 'Materiais Elétricos',
    categorySlug: 'cabos-e-fios',
...
export const pisosRevestimentos: Product[] = [
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7908597504167_1-300x300.webp'),
    category: 'Pisos e Revestimentos',
    categorySlug: 'pisos-e-revestimentos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898625861129_1-300x300.webp'),
    category: 'Pisos e Revestimentos',
    categorySlug: 'pisos-e-revestimentos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7896880006224_1-300x300.webp'),
    category: 'Pisos e Revestimentos',
    categorySlug: 'pisos-e-revestimentos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/carjas-s3-ecommerce-carajasonline-7898927960100_1-300x300-1.png'),
    category: 'Material de Construção',
    categorySlug: 'material-de-construcao',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898625863123_1-300x300.webp'),
    category: 'Pisos e Revestimentos',
    categorySlug: 'pisos-e-revestimentos',
...
export const eletrodomesticos: Product[] = [
  {
    ...
    image: wp('/wp-content/uploads/2023/12/transferir-2022-09-10T183834.054-1-300x300.jpg'),
    category: 'Eletrodomésticos',
    categorySlug: 'eletrodomesticos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/transferir-2022-09-10T200142.389-1-300x300.jpg'),
    category: 'Eletrodomésticos',
    categorySlug: 'eletrodomesticos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/transferir-2022-09-10T193917.171-1-300x300.jpg'),
    category: 'Eletrodomésticos',
    categorySlug: 'eletrodomesticos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/12g-1-300x300.jpg'),
    category: 'Eletrodomésticos',
    categorySlug: 'eletrodomesticos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/liquidificador-mondial-turbo-power-3-velocidades-500w-220v-preto-l-99-fb_1583257834_gg-1-300x300.jpg'),
    category: 'Eletrodomésticos',
    categorySlug: 'eletrodomesticos',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2023/12/transferir-2022-09-11T054000.044-1-300x300.jpg'),
    category: 'Eletrodomésticos',
    categorySlug: 'eletrodomesticos',
...
export const telhas: Product[] = [
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898591255502_1-300x300.webp'),
    category: 'Telhas',
    categorySlug: 'telhas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898187882365_1-300x300.webp'),
    category: 'Telhas',
    categorySlug: 'telhas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7897871109795_1-300x300.webp'),
    category: 'Telhas',
    categorySlug: 'telhas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898649610536_1-1-300x300.webp'),
    category: 'Telhas',
    categorySlug: 'telhas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898591255649_1-300x300.webp'),
    category: 'Telhas',
    categorySlug: 'telhas',
...
export const banheiro: Product[] = [
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7896902181106_1-300x300.webp'),
    category: 'Banheiro',
    categorySlug: 'banheiro',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7898010801877_1-300x300.webp'),
    category: 'Banheiro',
    categorySlug: 'banheiro',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7908656101283_1-300x300.webp'),
    category: 'Banheiro',
    categorySlug: 'banheiro',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7891461490232_1-300x300.png'),
    category: 'Banheiro',
    categorySlug: 'banheiro',
...
export const ferramentas: Product[] = [
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7891114164350_1-300x300.webp'),
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7893946510602_1-300x300.webp'),
    category: 'Ferramentas',
    categorySlug: 'ferramentas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-4059952629797_1-300x300.webp'),
    category: 'Ferramentas',
    categorySlug: 'ferramentas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7893946770587_1-300x300.webp'),
    category: 'Ferramentas',
    categorySlug: 'ferramentas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7897371610739_1-300x300.webp'),
    category: 'Ferramentas',
    categorySlug: 'ferramentas',
  ...
  },
  {
    ...
    image: wp('/wp-content/uploads/2024/06/carjas-s3-ecommerce-carajasonline-7893946837976_1-300x300.webp'),
    category: 'Ferramentas',
    categorySlug: 'ferramentas',
